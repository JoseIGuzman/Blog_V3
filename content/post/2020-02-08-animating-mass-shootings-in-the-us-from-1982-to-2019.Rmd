...
=======
The available data contains 117 mass shooting cases with variables such as the case name, the date of the mass shooting, the number of fatalities, and injuries, total victims (fatalities and injuries combined),the race and gender of the shooter, and the type of shooting (mass or spree). For the animation I used the latitude, longitude to map the points of the shooting location, and the year variables that will be used to progressively reveal the shootings. Each point was sized by the total number of victims. 
>>>>>>> 36b3972052b9751a906e4b0445d8dc19c5da65be
