...
The *NY Times* recently published an [article](https://www.nytimes.com/interactive/2019/05/17/upshot/game-of-thrones-imdb-ratings.html) showing a line graph of IMBd average fan ratings of "Game of Thrones" ("GOT") episodes over the seasons (as well as line graphs of other popular Tv shows). The authors Josh Katz and K.K. Rebbeca Lai faceted the graph by season, and also added labels with the names of some the episodes with the highest ratings, and one episode from the last season, "The Last of the Starks", with the all-time low 5.6 average rating for the show.
